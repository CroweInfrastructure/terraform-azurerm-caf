output "display_name" {
  value       = azuread_group.gro.display_name
  description = "The display name for the group"
}
output "assignable_to_role" {
  value       = azuread_group.gro.assignable_to_role
...
output "external_senders_allowed" {
  value       = azuread_group.gro.external_senders_allowed
...
output "hide_from_address_lists" {
  value       = azuread_group.gro.hide_from_address_lists
...
output "hide_from_outlook_clients" {
  value       = azuread_group.gro.hide_from_outlook_clients
...
output "mail_enabled" {
  value       = azuread_group.gro.mail_enabled
...
output "mail_nickname" {
  value       = azuread_group.gro.mail_nickname
  description = "The mail alias for the group, unique in the organisation"
}
output "members" {
  value       = azuread_group.gro.members
...
output "owners" {
  value       = azuread_group.gro.owners
...
output "theme" {
  value       = azuread_group.gro.theme
  description = "The colour theme for a Microsoft 365 group"
}
output "types" {
  value       = azuread_group.gro.types
...
output "onpremises_domain_name" {
  value       = azuread_group.gro.onpremises_domain_name
...
output "onpremises_netbios_name" {
  value       = azuread_group.gro.onpremises_netbios_name
...
output "onpremises_sam_account_name" {
  value       = azuread_group.gro.onpremises_sam_account_name
...
output "onpremises_security_identifier" {
  value       = azuread_group.gro.onpremises_security_identifier
...
output "onpremises_sync_enabled" {
  value       = azuread_group.gro.onpremises_sync_enabled
...
output "preferred_language" {
  value       = azuread_group.gro.preferred_language
